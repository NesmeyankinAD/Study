...
int main() 
{
    ...
    std::cout << limit_db.GetData("key") << std::endl;    // 1-й запрос - с реального объекта
    std::cout << limit_db.GetData("key") << std::endl;    // 2-й запрос - с реального объекта
    std::cout << limit_db.GetData("key") << std::endl;    // 3-й запрос - "error"
